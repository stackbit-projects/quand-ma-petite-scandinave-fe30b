...
- type: hero_section
  ...
  content: "# Quand ma petite scandinave a **_vu_** que j'**_la_** regardait avec
    un peu d'bave \n\nElle m'a dit _glabedichlabediglabedichlacken, glambadibediglabedichwetten,
    glabedichlabegrodibotchiklagen, dabodjekadebotchibotchikouine_"
  actions:
  - type: action
    template: action
    title: See all items
